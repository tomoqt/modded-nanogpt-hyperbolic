...
class Hyperparameters:
    ...
    train_seq_len = 48*256 # FlexAttention sequence length - reduced for 4090 compatibility
    val_seq_len = 4*64*256 # FlexAttention sequence length for validation - reduced for 4090 compatibility
    # optimization
...
for step in range(train_steps + 1):
    ...
    # Check for any None gradients and warn if found
